...
__host__ __device__ __forceinline__ void multAB(float a11, float a12, float a13, float a21, float a22, float a23,
...
__host__ __device__ __forceinline__ void multAtB(float a11, float a12, float a13, float a21, float a22, float a23,
                                                 float a31, float a32, float a33,
                                                 //
                                                 float b11, float b12, float b13, float b21, float b22, float b23,
                                                 float b31, float b32, float b33,
...
__host__ __device__ __forceinline__ void quatToMat3(const float* qV, float& m11, float& m12, float& m13, float& m21,
...
__host__ __device__ __forceinline__ void approximateGivensQuaternion(float a11, float a12, float a22, float& ch,
                                                                     float& sh)
{
    /*
...
__host__ __device__ __forceinline__ void jacobiConjugation(const int x, const int y, const int z, float& s11,
                                                           float& s21, float& s22, float& s31, float& s32, float& s33,
                                                           float* qV)
{
    float ch, sh;
    ...
    float& v11, float& v12, float& v13, float& v21, float& v22, float& v23, float& v31, float& v32, float& v33)
{
    ...
    multAtB(a11, a12, a13, a21, a22, a23, a31, a32, a33, a11, a12, a13, a21, a22, a23, a31, a32, a33, ATA11, ATA12,
            ATA13, ATA21, ATA22, ATA23, ATA31, ATA32, ATA33);
    ...
    float b21, b22, b23;
    float b31, b32, b33;
    multAB(a11, a12, a13, a21, a22, a23, a31, a32, a33, v11, v12, v13, v21, v22, v23, v31, v32, v33, b11, b12, b13, b21,
           b22, b23, b31, b32, b33);
    ...
    // QR decomposition
    QRDecomposition(b11, b12, b13, b21, b22, b23, b31, b32, b33, u11, u12, u13, u21, u22, u23, u31, u32, u33, s11, s12,
                    s13, s21, s22, s23, s31, s32, s33);
}

/// polar decomposition can be reconstructed trivially from SVD result
/// A = UP
__host__ __device__ __forceinline__ void pd(float a11, float a12, float a13, float a21, float a22, float a23, float a31,
                                            float a32, float a33,
                                            // output U
                                            ...
                                            float& p31, float& p32, float& p33)
{
    ...
    svd(a11, a12, a13, a21, a22, a23, a31, a32, a33, w11, w12, w13, w21, w22, w23, w31, w32, w33, s11, s12, s13, s21,
        s22, s23, s31, s32, s33, v11, v12, v13, v21, v22, v23, v31, v32, v33);

    // P = VSV'
    float t11, t12, t13, t21, t22, t23, t31, t32, t33;
    multAB(v11, v12, v13, v21, v22, v23, v31, v32, v33, s11, s12, s13, s21, s22, s23, s31, s32, s33, t11, t12, t13, t21,
           t22, t23, t31, t32, t33);

    multAB(t11, t12, t13, t21, t22, t23, t31, t32, t33, v11, v21, v31, v12, v22, v32, v13, v23, v33, p11, p12, p13, p21,
           p22, p23, p31, p32, p33);

    // U = WV'
    multAB(w11, w12, w13, w21, w22, w23, w31, w32, w33, v11, v21, v31, v12, v22, v32, v13, v23, v33, u11, u12, u13, u21,
           u22, u23, u31, u32, u33);
}


__host__ __device__ __forceinline__ void svd(const mat3& A, mat3& U, mat3& S, mat3& V)
{
    float u11, u12, u13, u21, u22, u23, u31, u32, u33;
    float s11, s12, s13, s21, s22, s23, s31, s32, s33;
    float v11, v12, v13, v21, v22, v23, v31, v32, v33;
    svd(A(0, 0), A(0, 1), A(0, 2), A(1, 0), A(1, 1), A(1, 2), A(2, 0), A(2, 1), A(2, 2), u11, u12, u13, u21, u22, u23,
        u31, u32, u33, s11, s12, s13, s21, s22, s23, s31, s32, s33, v11, v12, v13, v21, v22, v23, v31, v32, v33);
    U << u11, u12, u13, u21, u22, u23, u31, u32, u33;
    S << s11, s12, s13, s21, s22, s23, s31, s32, s33;
    V << v11, v12, v13, v21, v22, v23, v31, v32, v33;
}

__host__ __device__ __forceinline__ mat3 pd(const mat3& A)
{
    mat3 U, S, V;
    svd(A, U, S, V);
...
__host__ __device__ __forceinline__ mat3 pd_eigen(const mat3& A)
{
//    auto svd = A.jacobiSvd(Eigen::ComputeFullV | Eigen::ComputeFullU);
     Eigen::JacobiSVD<mat3> svd(A, Eigen::ComputeFullV | Eigen::ComputeFullU);
...
__host__ __device__ __forceinline__ mat3 pd_eigen2(const mat3& C)
{
    ...
    {
        Eigen::SelfAdjointEigenSolver<mat3> saes(C * C.transpose());
        mat3 test = saes.eigenvectors();
        U1.col(0) = test.col(2);
        U1.col(1) = -test.col(1);
        U1.col(2) = -test.col(0);
    }
    {
        Eigen::SelfAdjointEigenSolver<mat3> saes(C.transpose() * C);
        mat3 test = saes.eigenvectors();
        V1.col(0) = test.col(2);
        V1.col(1) = test.col(1);
        V1.col(2) = -test.col(0);
