               ...
               public glfw_MouseListener
{
   ...
   private:
    ...
    const char* scenarios[11] = {"N Particles", "10K Particles", "1M Particles", "Rigid Bodies (Cuboids)", "Rigid Bodies (Cuboids + Teapod)", "Rigid Bodies (SDF demo)", "Particles + Rigid Bodies (Cuboids + Teapod)", "Fluid (dam break + Obstacle)", "Fluid (dam break demo)", "Fluid (double dam break demo)", "Cloth test"};
    int scenario = 8;
